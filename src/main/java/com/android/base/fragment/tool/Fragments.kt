...
class EnhanceFragmentTransaction constructor(
     ...
     * 如果 [containerId]==0，则使用 [com.android.base.fragment.FragmentModuleConfig.defaultFragmentContainerId] 中配置的 id 作为容器 id，
    ...
    /**
     * 添加指定的 [fragment]，默认使用 [com.android.base.fragment.FragmentModuleConfig.defaultFragmentContainerId] 中配置的 id 作为容器 id，如果 [tag] 为 null，则使用指定 [fragment] 的全限定类名。
     */
    fun addFragment(
        fragment: Fragment,
        tag: String = fragment::class.java.name,
    ...
    /**
     * 替换为指定的 [fragment]，id 使用 [com.android.base.fragment.FragmentModuleConfig.defaultFragmentContainerId] 中配置的 id 作为容器 id，如果 [tag] 为 null，则使用指定 [fragment] 的全限定类名。
     */
    fun replaceFragment(
        fragment: Fragment,
        tag: String = fragment::class.java.name,
